...
Garmin Peak currently uses a local AI model called Ollama; through “Tool Calling,” the model can choose to retrieve the data itself using the Garmin Connect API.
